...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        r1.setBounds(120,150,150,30);
        add(r1);
        
        r2.setBounds(400,150,300,30);
        add(r2);
        
        r3.setBounds(120,200,250,30);
        add(r3);
        ...
        l8.setBounds(300,320,200,30);
        add(l8);
        
        l9.setBounds(80,360,200,20);
        add(l9);
        
        l10.setBounds(80,400,200,30);
        add(l10);
        ...
        c7.setBounds(80,580,600,20);
        add(c7);
        
        b1.setBounds(150,620,100,30);
        add(b1);
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    String q2 = "insert into loginnn values('"+formno+"','"+cardnumber+"','"+pin+"')";
